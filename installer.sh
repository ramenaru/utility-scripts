...
nginx ffmpeg mpv bluez bluez-utils ttf-liberation ttf-dejavu ttf-font-awesome ttf-jetbrains-mono ttf-firacode rsync less reflector fzf go noto-fonts-cjk nerd-fonts alacritty feh upower acpi flameshot bluetoothctl"
